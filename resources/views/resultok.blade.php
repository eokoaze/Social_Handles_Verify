...
<section id="section-main" class="vertical-center let-it-snow" data-bgimage="url(/assets/home/images/1.jpg) top">                        
<center>
<div class="col-lg-5 text-center" style="color: #000000; background-color: #FFF; border-radius: 5px; margin: 10px; padding: 30px;">

    <span style="font-size: 16px; font-color: #000000;"> <strong>
